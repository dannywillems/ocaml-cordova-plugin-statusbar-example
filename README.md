...
This is an example of the binding to the *statusbar cordova plugin*. See the
...
You need to install the plugin *cordova-plugin-statusbar*. The Makefile contains
...
* init_plugins: initialize plugins you need. Contains cordova-plugin-statusbar
  for this project.
